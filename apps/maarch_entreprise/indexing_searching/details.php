    ...
    if ($stmt->rowCount() == 0) {
        ...
        $data = get_general_data($coll_id, $s_id, $mode_data, $param_data); ?>
            ...
            <?php 
                ...
                <dt class="fa fa-info-circle" style="font-size:2em;padding-left: 15px;<?php if (strpos($_SERVER['HTTP_USER_AGENT'], 'Chrome')) {
                    echo 'padding-right: 0px;';
                } else {
                    echo 'padding-right: 15px;';
                } ?>" title="<?php echo _PROPERTIES; ?>"> <sup><span style="font-size: 10px;<?php echo $style; ?>" class="nbResZero">0</span></sup></dt>
                <dd>
        ...
        ?>
                ...
                if ($core->is_module_loaded('entities')) {
                    ...
                    $diffList_frame .= '<dt class="fa fa-share-alt" style="display:block !important;font-size:2em;padding-left: 15px;';
