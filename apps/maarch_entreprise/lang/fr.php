...
if (!defined('_MEP_VERSION')) {
    define('_MEP_VERSION', 'Maarch v17.11');
}
...
if (!defined('_PLEASE_CHECK_LISTDIFF')) {
    define('_PLEASE_CHECK_LISTDIFF', ' est dans une ou des listes de diffusion. Veuillez le remplacer dans la ou les listes de ');
}
...
if (!defined('_FROM_GROUPS')) {
    define('_FROM_GROUPS', 'des groupes');
}
if (!defined('_FROM_ENTITY')) {
    define('_FROM_ENTITY', "de l'entité");
}
if (!defined('_FROM_ENTITIES')) {
    define('_FROM_ENTITIES', 'des entités');
}
if (!defined('_IN_GROUP')) {
    define('_IN_GROUP', 'au groupe');
}
if (!defined('_IN_GROUPS')) {
    define('_IN_GROUPS', 'aux groupes');
}
if (!defined('_IN_ENTITY')) {
    define('_IN_ENTITY', "à l'entité");
}
if (!defined('_IN_ENTITIES')) {
    define('_IN_ENTITIES', 'aux entités');
}
...
if (!defined('_ACTION_DELETED')) {
    define('_ACTION_DELETED', "Suppression de l'action");
}
...
if (!defined('_ACTION_ADDED')) {
    define('_ACTION_ADDED', "Ajout d'une nouvelle action");
}
...
if (!defined('_DOCTYPE_ADDED')) {
    define('_DOCTYPE_ADDED', 'Nouveau type de document ajouté');
}
if (!defined('_DELETED_DOCTYPE')) {
    define('_DELETED_DOCTYPE', 'Type de document supprimé');
}
...
if (!defined('_CLOSE_MAIL_WITH_ATTACHMENT')) {
    define('_CLOSE_MAIL_WITH_ATTACHMENT', 'Clôture avec pièce jointe');
}
...
if (!defined('_INDIVIDUAL')) {
    define('_INDIVIDUAL', 'Personne physique');
}
...
if (!defined('_NO_SOCIETY_DUPLICATES')) {
    define('_NO_SOCIETY_DUPLICATES', 'Pas de doublon par organisme/société');
}
if (!defined('_NO_NAME_DUPLICATES')) {
    define('_NO_NAME_DUPLICATES', 'Pas de doublon par nom/prénom');
}
...
if (!defined('_CHOOSE_CATEGORY_ASSOCIATION_HELP')) {
    define('_CHOOSE_CATEGORY_ASSOCIATION_HELP', "Si aucune catégorie sélectionnée alors l'action est valable pour toute les catégories");
}
...
if (!defined('_TAG_ADMIN')) {
    define('_TAG_ADMIN', 'Administration des mots-clés');
}
