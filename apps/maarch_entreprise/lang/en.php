...
if (!defined('_STATUS_DELETED')) {
    define('_STATUS_DELETED', 'Status deletion');
}
if (!defined('_DEL_STATUS')) {
    define('_DEL_STATUS', 'Deleted status');
}
if (!defined('_MODIFY_STATUS')) {
    define('_MODIFY_STATUS', 'Status modification');
}
if (!defined('_STATUS_ADDED')) {
    define('_STATUS_ADDED', 'New status addition');
}
...
if (!defined('_CAN_BE_SEARCHED')) {
    define('_CAN_BE_SEARCHED', 'Search');
}
if (!defined('_CAN_BE_MODIFIED')) {
    define('_CAN_BE_MODIFIED', 'Index modification');
}
...
if (!defined('_IMG_RELATED')) {
    define('_IMG_RELATED', 'Associated picture');
}
...
if (!defined('_ACTION_DELETED')) {
    define('_ACTION_DELETED', 'Action deletion');
}
...
if (!defined('_ACTION_ADDED')) {
    define('_ACTION_ADDED', 'New action addition');
}
...
if (!defined('_DOCTYPE_UPDATED')) {
    define('_DOCTYPE_UPDATED', ' Modified document type');
}
if (!defined('_DOCTYPE_UPDATE')) {
    define('_DOCTYPE_UPDATE', ' Document type modification');
}
if (!defined('_DOCTYPE_ADDED')) {
    define('_DOCTYPE_ADDED', 'New added document type');
}
if (!defined('_DELETED_DOCTYPE')) {
    define('_DELETED_DOCTYPE', ' Deleted document type');
}
...
if (!defined('_VISA_USER_SEARCH_MIN')) {
    define('_VISA_USER_SEARCH_MIN', 'Visa user');
}
...
if (!defined('_NO_SOCIETY_DUPLICATES')) {
    define('_NO_SOCIETY_DUPLICATES', 'No duplication by organization/ company');
}
if (!defined('_NO_NAME_DUPLICATES')) {
    define('_NO_NAME_DUPLICATES', 'No duplication by name/ first name');
}
...
if (!defined('_WARNING_MESSAGE_DEL_CONTACT_TYPE')) {
    define('_WARNING_MESSAGE_DEL_CONTACT_TYPE', 'Warning : the contact type deletion leads to contacts reallocation to a new contact type.;');
}
...
if (!defined('_WARNING_MESSAGE_DEL_CONTACT_PURPOSE')) {
    define('_WARNING_MESSAGE_DEL_CONTACT_PURPOSE', 'Warning : The denomination deletion leads to addresses reallocation to a new denomination.');
}
...
if (!defined('_EXPORT_LIST')) {
    define('_EXPORT_LIST', 'Export (csv format)');
}
...
if (!defined('_DEL_LINK')) {
    define('_DEL_LINK', 'Delete connection');
}
...
if (!defined('_PRINT_DOC_FROM_LIST')) {
    define('_PRINT_DOC_FROM_LIST', 'Print the liaison sheets');
}
