    ...
    public function addupcontact($mode, $admin = true, $confirm = 'N', $mycontact = 'N')
    {
        ...
        if (!empty($_SESSION['error'])) {
            ...
            if ($mode == 'add') {
                ...
                $arrayPDO = array($_SESSION['m_admin']['contact']['CONTACT_TYPE'], $_SESSION['m_admin']['contact']['LASTNAME'], $_SESSION['m_admin']['contact']['FIRSTNAME'], $_SESSION['m_admin']['contact']['SOCIETY'], $_SESSION['m_admin']['contact']['SOCIETY_SHORT'], $_SESSION['m_admin']['contact']['FUNCTION'], $_SESSION['m_admin']['contact']['OTHER_DATA'], $_SESSION['m_admin']['contact']['TITLE'], $_SESSION['m_admin']['contact']['IS_CORPORATE_PERSON'], $_SESSION['m_admin']['contact']['ID']);
        ...
        <div id="inner_content_contact" class="clearfix" align="center" style="margin-bottom:15px;width:100% !important;"> 
            ...
            if ($state == false) {
                ...
                <table id="frmcontact_table">
                    ...
                    ?> checked="checked"<?php
                } ?> onclick="javascript:show_admin_contacts( true, '<?php functions::xecho($display_value); ?>');setContactType('corporate', '<?php echo $can_add_contact; ?>')" id="corpo_yes"><span onclick="$j('#corpo_yes').click();" onmouseover="this.style.cursor='pointer';"><?php echo _IS_CORPORATE_PERSON; ?></span>                        
                            </span>
                    ...
                    ?> checked="checked"<?php
                } ?> onclick="javascript:show_admin_contacts( false, '<?php functions::xecho($display_value); ?>');setContactType('no_corporate', '<?php echo $can_add_contact; ?>')" id="corpo_no"><span onclick="$j('#corpo_no').click();" onmouseover="this.style.cursor='pointer';"><?php echo _INDIVIDUAL; ?></span>
                            </span>
                        </td>
                        <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
                        <td>&nbsp;</td>
    ...
    public function get_contact_form()
    {
        ...
        <form class="forms">
            ...
            <div id="info_contact_div" style="display:inline;">
                <table width="65%" >
                    <tr>
                        <td class="indexing_field" align="left" align="center" colspan="3">
