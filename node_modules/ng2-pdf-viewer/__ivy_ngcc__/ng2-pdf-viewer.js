...
PdfViewerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PdfViewerComponent, selectors: [["pdf-viewer"]], hostBindings: function PdfViewerComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("resize", function PdfViewerComponent_resize_HostBindingHandler() { return ctx.onPageResize(); }, false, ɵngcc0.ɵɵresolveWindow)("textlayerrendered", function PdfViewerComponent_textlayerrendered_HostBindingHandler($event) { return ctx.onTextLayerRendered($event); });
    } }, inputs: { cMapsUrl: ["c-maps-url", "cMapsUrl"], page: "page", renderText: ["render-text", "renderText"], renderTextMode: ["render-text-mode", "renderTextMode"], originalSize: ["original-size", "originalSize"], showAll: ["show-all", "showAll"], stickToPage: ["stick-to-page", "stickToPage"], zoom: "zoom", rotation: "rotation", externalLinkTarget: ["external-link-target", "externalLinkTarget"], autoresize: "autoresize", fitToPage: ["fit-to-page", "fitToPage"], src: "src" }, outputs: { afterLoadComplete: "after-load-complete", pageRendered: "page-rendered", textLayerRendered: "text-layer-rendered", onError: "error", onProgress: "on-progress", pageChange: "pageChange" }, features: [ɵngcc0.ɵɵNgOnChangesFeature], decls: 2, vars: 0, consts: [[1, "ng2-pdf-viewer-container"], [1, "pdfViewer"]], template: function PdfViewerComponent_Template(rf, ctx) { if (rf & 1) {
