...
<?php
            ...
            } elseif (isset($_SESSION['attachmentInfo']['inProgressResId'])) {

            //MODE SECOND BACKUP AND MORE
            } elseif (isset($_SESSION['attachmentInfo'][$i]['inProgressResId'])) {
                ...
                } elseif ($_SESSION['targetAttachment'] == 'edit') {
                    $tableName = 'res_version_attachments';
                }
                
                //UPDATE NEW FILE PATH
                $db->query(
                    'UPDATE '.$tableName.' SET fingerprint = ?, filesize = ?, path = ?, filename = ? WHERE res_id = ?',
            ...
            //MODE FIRST BACKUP
                ...
                } elseif (isset($_SESSION['attachmentInfo'][$i]['contactId']) && $_SESSION['attachmentInfo'][$i]['contactId'] != '' && !is_numeric($_SESSION['attachmentInfo'][$i]['contactId'])) {
                    $_SESSION['data'][] = [
                            'column' => 'dest_user',
                ...
                if (isset($_SESSION['attachmentInfo'][$i]['addressId']) && $_SESSION['attachmentInfo'][$i]['addressId'] <> '' && is_numeric($_SESSION['attachmentInfo'][$i]['addressId'])) {
