...
if (!defined('_FILESTAT_LIST_DESC')) {
    define('_FILESTAT_LIST_DESC', 'Show list of statistics files available.');
}
if (!defined('_FILESTAT_DESC')) {
    define('_FILESTAT_DESC', 'These files are generated by </b>crontab<b> located in <b>life_cycle</b> module.<br/>Only <b>last 10 files</b> are displayed.');
}
if (!defined('_NO_STAT_FILES_AVAILABLE')) {
    define('_NO_STAT_FILES_AVAILABLE', 'No stat file available in folder: ');
}
