...
INSERT INTO attachment_types (id, type_id, label, visible, email_link, signable, icon, chrono, version_enabled, new_version_default) VALUES (10, 'shipping_deposit_proof', 'Preuve de dépôt Maileva', false, false, false, 'M', false, false, false);
INSERT INTO attachment_types (id, type_id, label, visible, email_link, signable, icon, chrono, version_enabled, new_version_default) VALUES (11, 'shipping_acknowledgement_of_receipt', 'Accusé de réception Maileva', false, false, false, 'M', false, false, false);
