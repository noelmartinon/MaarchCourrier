...
--                                                                          --
-- *************************************************************************--
UPDATE parameters SET param_value_string = '20.03.19' WHERE id = 'database_version';
...
INSERT INTO custom_fields (id, label, type, values) VALUES (1, 'Nature', 'select', '["Lettre", "Courriel", "Ouvrage / Brochure / Rapport", "Courrier postal recommandé", "Courrier PM", "Retour de transmission"]');
...
DO $$ BEGIN
  IF (SELECT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'mlb_coll_ext')) THEN
    ...
    UPDATE res_letterbox SET custom_fields = json_build_object('1', 'Ouvrage / Brochure / Rapport') FROM mlb_coll_ext WHERE res_letterbox.res_id = mlb_coll_ext.res_id AND mlb_coll_ext.nature_id in ('fax', 'other', 'courier','report_brochure');
    UPDATE res_letterbox SET custom_fields = json_build_object('1', 'Courrier postal recommandé') FROM mlb_coll_ext WHERE res_letterbox.res_id = mlb_coll_ext.res_id AND mlb_coll_ext.nature_id in ('chronopost', 'fedex','_mail_ar');
...
INSERT INTO indexing_models_fields (model_id, identifier, mandatory, default_value, unit) VALUES (1, 'indexingCustomField_1', FALSE, '"Lettre"', 'mail');
...
INSERT INTO indexing_models_fields (model_id, identifier, mandatory, default_value, unit) VALUES (2, 'indexingCustomField_1', FALSE, '"Lettre"', 'mail');
...
INSERT INTO indexing_models_fields (model_id, identifier, mandatory, default_value, unit) VALUES (3, 'indexingCustomField_1', FALSE, '"Lettre"', 'mail');
