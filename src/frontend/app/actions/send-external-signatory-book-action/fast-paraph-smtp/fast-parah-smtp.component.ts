...
@Component({
    selector: 'app-fast-paraph-smtp',
    templateUrl: 'fast-paraph-smtp.component.html',
    styleUrls: ['fast-paraph-smtp.component.scss']
})
export class FastParapheurSmtpComponent implements OnInit {
