...
export class HistoryComponent implements OnInit {
    ...
    @ViewChild('tableHistoryListSort') sort: MatSort;
    ...
    initHistoryMode() {
        ...
        if (this.fullHistoryMode) {
            this.extraParamUrl = '';
            this.filterListUrl = '../../rest/history/availableFilters';
        } else {
            this.extraParamUrl = '&onlyActions=true';
            this.filterListUrl = '../../rest/history/availableFilters?onlyActions=true';
        }
    }
